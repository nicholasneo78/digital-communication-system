...
sym_num = 1; %number of symbols in stream
switch M
    case 2
...
ber2 = berawgn(EbNo,'fsk',2,'coherent');
ber4 = berawgn(EbNo,'fsk',4,'coherent');
ber8 = berawgn(EbNo,'fsk',8,'coherent');
figure;
semilogy(EbNo,[ber2 ber4 ber8], 'LineWidth',2); xlabel("dB"); ylabel("BER");
